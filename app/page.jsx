...
export default function HomePage() {
  ...
  return (
    ...
    >
      ...
      >
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 md:px-8 py-4">
          <a
            href="#home"
            className={cx(
          ...
          <div className="hidden md:flex items-center gap-8 text-[11px] tracking-[0.26em] uppercase">
            {[
              ["Home", "#home"],
              ["About", "#about"],
              ["Services", "#services"],
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:block">
              <Button href="#contact" variant="ghostGold" className="px-5 py-2.5">
        ...
        >
          ...
          <div className="mx-auto max-w-6xl px-5 md:px-8 pb-6">
            <div className="rounded-3xl border border-white/10 bg-[#0A0A0A]/95 backdrop-blur-xl p-5 shadow-[0_30px_80px_rgba(0,0,0,0.8)]">
              ...
              <div className="mt-4">
                <Button href="#contact" variant="ghostGold" className="w-full">
                  Book Now <ArrowRight className="h-4 w-4" />
                </Button>
              </div>
            </div>
      ...
      <main id="home">
        <section className="relative min-h-[100vh] overflow-hidden">
          ...
          <div className="relative mx-auto flex min-h-[100vh] max-w-6xl flex-col justify-center px-5 md:px-8 pt-24 pb-20">
            <motion.div
              initial="hidden"
              animate="visible"
              variants={stagger}
            ...
            >
              ...
              >
                WEDDING STORYTELLERS · HYDERABAD
              </motion.p>

              <motion.h1
                variants={fadeInUp}
                className="mt-7 font-[var(--font-serif)] font-semibold leading-[0.95] text-5xl sm:text-6xl lg:text-7xl"
              >
                Made in Heaven,
                <br />
                <span className="text-white">Framed by RVR PRO</span>
              </motion.h1>
              ...
              >
                Dark, cinematic wedding films and photography—crafted like a
                feature, felt like a memory.
              </motion.p>
              ...
              >
                <Button href="#gallery" variant="solid">
                  View Our Work <Play className="h-4 w-4" />
                </Button>
                <Button href="#contact" variant="ghostWhite">
        ...
        <section
          id="about"
          className={cx("relative", isDark ? "bg-[#0A0A0A]" : "bg-[#FCF9F5]")}
        >
          <div className="mx-auto max-w-6xl px-5 md:px-8 py-16 md:py-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                ...
                <div className="mt-10">
                  <Button href="#contact" variant="ghostGold">
        ...
        <section
          id="services"
          className={cx("relative", isDark ? "bg-[#111111]" : "bg-[#E8E2D6]")}
        >
          <div className="mx-auto max-w-6xl px-5 md:px-8 py-16 md:py-24">
            <motion.div
              initial="hidden"
              ...
              style={{ willChange: "transform" }}
            >
              <SectionTitle kicker="What We Craft" title="Services built like cinema." center />
              <p
                className={cx(
              ...
              >
                Films, photography, and albums that preserve your wedding with
                drama, detail, and timeless restraint.
              </p>
            </motion.div>
              ...
              {[
                {
                  icon: Film,
                  title: "Films",
                  desc: "Moody, cinematic storytelling with pacing, sound, and color that feels like a feature.",
                },
                {
                  icon: Camera,
                  title: "Photography",
                  desc: "Bold compositions and honest emotion—crafted with luxury editorial polish.",
                },
                {
                  icon: ImageIcon,
                  title: "Albums",
                  desc: "Heirloom books designed like a magazine spread—built to be touched and kept.",
                },
              ].map((s) => (
                <motion.div
                  key={s.title}
                ...
                >
                  ...
                  />
                  <div className="mt-5 inline-flex items-center gap-2 text-xs tracking-[0.22em] uppercase text-white/70 group-hover:text-white transition">
                    Explore <ArrowRight className="h-4 w-4 text-[#C9A84C]" />
                  </div>
                </motion.div>
              ))}
            </motion.div>
        ...
        >
          <div className="mx-auto max-w-6xl px-5 md:px-8 py-16 md:py-24">
            ...
            >
              <h2
                className={cx(
                  "font-[var(--font-serif)] text-3xl md:text-5xl",
                  isDark ? "text-white" : "text-[#333333]"
                )}
              >
                Framed Forever
              ...
              >
                A mixed grid—high contrast, rich shadows, and gold highlights.
              </p>
            </motion.div>
                ...
                <div key={img.id} className="mb-6 break-inside-avoid">
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundImage: `url('https://picsum.photos/900/1200?random=${img.id}')`,
                      }}
                    />
                    <div className={cx("absolute inset-0", isDark ? "bg-black/25" : "bg-black/10")} />
          ...
          <div className="relative mx-auto max-w-6xl px-5 md:px-8 py-20 md:py-28">
            ...
            >
              ...
              <div className="mt-10 flex justify-center">
                <Button href="#contact" variant="solid" className="px-8 py-3.5">
